...
//TODO:=======================
//Напишіть ф-цію calcTotalPrice(stones, stonesName), яка приймає масив 
//об'єктів і рядок з назвою каменю.
...
//TODO:=======================
//Напишіть функцію updateObject, яка приймає обʼєкт і повертає
//новий обʼєкт без вказаних параметрів
